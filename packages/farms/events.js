...
module.exports = {
    ...
    'farms.zone.menu.open': (player) => {
        ...
        zoneData.npcPos = farms.farmNpcPos ? { x: farms.farmNpcPos.x, y: farms.farmNpcPos.y, z: farms.farmNpcPos.z, heading: farms.farmNpcPos.heading } : null;
    ...
    'farms.zone.menu.save': async (player, zoneJson) => {
        ...
        payload.npcPos = farms.farmNpcPos ? { x: farms.farmNpcPos.x, y: farms.farmNpcPos.y, z: farms.farmNpcPos.z, heading: farms.farmNpcPos.heading } : null;
