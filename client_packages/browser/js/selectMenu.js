var selectMenu = new Vue({
    ...
    data: {
        ...
        menus: {
                        ...
                        switch (e.itemName) {
                            ...
                            case "Сохранить и продолжить":
                                if (!selectMenu.menu.isChange) {
                                    ...
                                    mp.trigger('characterInit.create', false);
            ...
            "characterCreateNameMenu": {
                ...
                header: "Имя персонажа", // заголовок меню, видимый на экране
                items: [{
                        text: "Имя",
                        values: [""],
                        i: 0,
    ...
    header: "Взяточник",
    items: [
        { text: "Купить лицензию на авто ($500)" },
        { text: "Купить лицензию на мото ($300)" },
        { text: "Купить лицензию на грузовик ($700)" },
        { text: "Закрыть меню" }
    ],
    i: 0,
    j: 0,
    handler(eventName) {
        var item = this.items[this.i];
        if (eventName == 'onItemSelected') {
            if (item.text.includes("авто")) {
                selectMenu.show = false;
                mp.trigger("license.buy", "car");
            }
            if (item.text.includes("мото")) {
                selectMenu.show = false;
                mp.trigger("license.buy", "bike");
            }
            if (item.text.includes("грузовик")) {
                selectMenu.show = false;
                mp.trigger("license.buy", "truck");
            }
            if (item.text == "Закрыть меню")
                selectMenu.show = false; {
                mp.trigger("license.menu.close");
            }
        }
    }
},
...
"dogMenu": {
    name: "dog",
    header: "Магазин собак",
    items: [
        { text: "Купить Хаски ($15,000)" },
        { text: "Купить Немецкую овчарку ($12,000)" },
        { text: "Купить Ротвейлера ($18,000)" },
        { text: "Купить Лабрадора ($10,000)" },
        { text: "Купить Бульдога ($14,000)" },
        { text: "Закрыть меню" }
    ],
    i: 0,
    j: 0,
    handler(eventName) {
        var item = this.items[this.i];
        if (eventName == 'onItemSelected') {
            if (item.text.includes("Хаски")) {
                selectMenu.show = false;
                mp.trigger("dog.buy", "husky");
            }
            if (item.text.includes("овчарку")) {
                selectMenu.show = false;
                mp.trigger("dog.buy", "shepherd");
            }
            if (item.text.includes("Ротвейлера")) {
                selectMenu.show = false;
                mp.trigger("dog.buy", "rottweiler");
            }
            if (item.text.includes("Лабрадора")) {
                selectMenu.show = false;
                mp.trigger("dog.buy", "labrador");
            }
            if (item.text.includes("Бульдога")) {
                selectMenu.show = false;
                mp.trigger("dog.buy", "bulldog");
            }
            if (item.text == "Закрыть меню") {
                selectMenu.show = false;
                mp.trigger("dog.menu.close");
            }
        }
    }
},
...
"faction_garage": {
    ...
    handler(eventName) {
        ...
        if (eventName == 'onItemSelected') {
            // Если выбрана машина (есть meta данные)
            if (item.meta && item.meta.sqlId) {
                // Проверяем не заспавнена ли уже
                if (item.meta.isSpawned) {
                    selectMenu.notification = 'Машина уже в мире';
                    return;
                }
...
"faction_garage": {
        ...
        if (eventName === 'onItemSelected') {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        if (e.itemName == 'Продать рыбу') {
                            mp.trigger(`fishing.fish.sell`, false);
                        } else if (e.itemName == 'Помощь') {
                            selectMenu.show = false;
            ...
            "fishingPort": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        if (e.itemName == 'Продать рыбу') {
                            mp.trigger(`fishing.fish.sell`, true);
                        }
                    }
                }
            },
            "boatsRent": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') {
                            mp.trigger(`vehicles.boats.rent.enter`, false);
                        } else {
                            selectMenu.loader = true;
                            mp.trigger('callRemote', 'vehicles.boats.rent.spawn', item.model);
                        }
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') selectMenu.show = false;
                            ...
                            var maxRankName = ranks[ranks.length - 1].name;
                            if (statistics['factionRank'].value != maxRankName) return selectMenu.notification = "Вы не лидер";
                            selectMenu.showByName("factionControlCommonHolder");
                        }
                    }
                }
            },
            "factionControlCommonHolder": {
                name: "factionControlCommonHolder",
                header: "Общий шкаф",
                items: [{
                    text: "Открыть",
                },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Открыть') {
                            selectMenu.show = false;
                            mp.trigger(`callRemote`, `factions.holder.common.state`, true);
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                            mp.trigger(`callRemote`, `factions.holder.common.state`, false);
            ...
            "governmentStorage": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        } else if (e.itemName == 'Управление казной') {
                            mp.trigger('callRemote', 'government.treasury.menu.show');
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "governmentItems": {
                ...
                items: [{
                        text: "Аптечка - 100 мат."
                    },
                    {
                        text: "Наручники - 100 мат.",
                    },
                    {
                        text: "Вернуться"
                    },
            ...
            "governmentGuns": {
                ...
                items: [{
                        text: "Stun Gun - 100 мат."
                    },
                    {
                        text: "Heavy Pistol - 100 мат."
                    },
                    {
                        text: "Assault SMG - 100 мат."
                    },
                    {
                        text: "Advanced Rifle - 100 мат."
                    },
                    {
                        text: "Bullpup Shotgun - 100 мат."
                    },
                    {
                        text: "Вернуться"
                    },
            ...
            "governmentAmmo": {
                ...
                items: [{
                    text: "Патроны - 9mm",
                    values: ["12 ед. - 12 мат.", "24 ед. - 24 мат.", "32 ед. - 32 мат."],
                },
                    {
                        text: "Патроны - 12mm",
                        values: ["8 ед. - 8 мат.", "16 ед. - 16 мат.", "24 ед. - 24 мат."],
                    },
                    {
                        text: "Патроны - 5.56mm",
                        values: ["12 ед. - 12 мат.", "24 ед. - 24 мат.", "32 ед. - 32 мат."],
                    ...
                    {
                        text: "Патроны - 7.62mm",
                        values: ["10 ед. - 10 мат.", "20 ед. - 20 мат.", "30 ед. - 30 мат."],
                    },
                    {
                        text: "Вернуться"
                    },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == "Оплата штрафов") {
                            ...
                            selectMenu.showByName("governmentServiceVehKeys");
                        } else if (e.itemName == "Смена имени") {
                            selectMenu.showByName("governmentServiceChangeName");
            ...
            "governmentServiceChangeName": {
                name: "governmentServiceChangeName",
                header: "Смена имени",
                items: [{
                        text: "Введите имя...",
                        type: "editable",
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == "Вернуться") selectMenu.showByName("governmentService");
                            ...
                            mp.trigger(`callRemote`, `government.nickname.change`, name);
                        }
                    } else if (eventName == 'onBackspacePressed') selectMenu.showByName("governmentService");
                }
            },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == "Сохранить") {
                            mp.trigger('government.tax.set', this.items[0].i, this.items[1].values[this.items[1].i].toFixed(4));
                        } else if (e.itemName == "Закрыть") {
                            selectMenu.show = false;
                        }
                    }
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Раздевалка') {
                            ...
                            mp.trigger('callRemote', 'factions.treasury.menu.show');
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "lspdClothes": {
                ...
                items: [{
                    ...
                    {
                        text: "Детектив №1 - 0 мат."
                    },
                    {
                        text: "Детектив №2 - 0 мат."
                    },
                    {
                        text: "SWAT - 0 мат."
                    },
            ...
            "lspdItems": {
                ...
                items: [{
                        text: "Наручники - 10 мат."
                    },
                    {
                        text: "Аптечка - 10 мат.",
                    },
                    {
                        text: "Бронежилет - 100 мат."
                    },
                    {
                        text: "Вернуться"
                    },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        else if (e.itemName.includes('Бронежилет')) mp.trigger(`callRemote`, `police.storage.armour.take`);
            ...
            "lspdGuns": {
                ...
                items: [{
                    ...
                    {
                        text: "Пистолет - 40 мат."
                    },
                    {
                        text: "SMG - 59 мат."
                    },
                    {
                        text: "Дробовик - 80 мат."
                    },
                    {
                        text: "Карабин - 100 мат."
                    },
                    {
                        text: "Вернуться"
                    },
            ...
            "lssdClothes": {
                name: "lssdClothes",
                header: "Раздевалка LSCSD",
                items: [{
                        text: "Кадет - 0 мат."
                    },
                    {
                        text: "Deputy Sheriff №1 - 0 мат."
                    },
                    {
                        text: "Deputy Sheriff №2 - 0 мат."
                    },
                    {
                        text: "Спец. Отдел - 0 мат."
                    },
                    {
                        text: "Мотопатруль - 0 мат."
                    },
                    {
                        text: "Зам. Шефа - 0 мат."
                    },
            ...
            "speedingRadars": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == "Установить") {
                            let speedLimit = parseInt(this.items[0].values[0]);
                            if (isNaN(speedLimit)) return selectMenu.notification = "Ограничение скорости должно быть числом";
                            if (speedLimit < 20) return selectMenu.notification = "Ограничение скорости должно быть больше 30 км/ч";
                            mp.trigger(`callRemote`, `speedingradars.create`, speedLimit);
                        } else if (e.itemName == "Убрать") {
                            mp.trigger(`callRemote`, `speedingradars.remove`);
                        } else if (e.itemName == "Закрыть") {
                            selectMenu.show = false;
                        }
                    } else if (eventName == 'onBackspacePressed') selectMenu.show = false;
            ...
            "fibClothes": {
                ...
                items: [{
                    ...
                    {
                        text: "Агент (деловая) - 0 мат."
                    },
                    {
                        text: "Агент (рабочая) - 0 мат."
                    },
                    {
                        text: "ATF/HRT - 0 мат."
                    },
            ...
            "fibItems": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        else if (e.itemName.includes('Бронежилет')) mp.trigger(`callRemote`, `fib.storage.armour.take`);
            ...
            "fibGuns": {
                ...
                items: [{
                        text: "Heavy Sniper - 15000 мат."
                    },
                    {
                        text: "Carbine Rifle Mk II - 50 мат."
                    },
                    {
                        text: "Combat PDW - 50 мат."
                    },
                    {
                        text: "Pistol .50 - 40 мат."
                    },
                    {
                        text: "Stun Gun - 15 мат."
                    },
                    {
                        text: "Pump Shotgun Mk II - 80 мат."
                    },
                    {
                        text: "Вернуться"
                    },
            ...
            "armyClothes": {
                ...
                header: "Раздевалка",
                items: [{
                        text: "Новобранец - 0 мат."
                    },
                    {
                        text: "Сержант - 0 мат."
                    },
                    {
                        text: "Штаб-Сержант - 0 мат."
                    },
                    {
                        text: "Уоррент-Сержант - 0 мат."
                    },
                    {
                        text: "Мл. офицер - 0 мат."
                    },
                    {
                        text: "Ст. офицер - 0 мат."
                    },
                    {
                        text: "Парад. Офицер - 0 мат."
                    },
                    {
                        text: "Ген. Штаб - 0 мат."
                    },
                    {
                        text: "Парад. Ген. Штаб - 0 мат."
                    },
                    {
                        text: "Пилот - 0 мат."
                    },
            ...
            "armyItems": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        else if (e.itemName.includes('Бронежилет')) mp.trigger(`callRemote`, `army.storage.armour.take`);
            ...
            "hospitalItems": {
                ...
                items: [{
                        text: "Малая аптечка - 10 мат."
                    },
                    {
                        text: "Большая аптечка - 20 мат."
                    },
                    {
                        text: "Пластырь - 5 мат."
                    },
                    {
                        text: "Адреналин - 30 мат."
                    },
                    {
                        text: "Вернуться"
                    },
            ...
            "newsClothes": {
                ...
                items: [{
                    ...
                    {
                        text: "Мл. Состав - 0 мат."
                    },
                    {
                        text: "Ст. Состав - 0 мат."
                    },
                    {
                        text: "Директор - 0 мат."
                    },
            ...
            "bandStorage": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        } else if (e.itemName == 'Отмычка') {
                            mp.trigger('callRemote', 'bands.storage.lockPick.take');
            ...
            "bandGuns": {
                ...
                items: [{
                        text: "Baseball Bat - 50 мат."
                    },
                    {
                        text: "Pump Shotgun - 70 мат."
                    },
                    {
                        text: "Pistol - 50 мат."
                    },
                    {
                        text: "Combat Pistol - 60 мат."
                    },
                    {
                        text: "Micro SMG - 70 мат."
                    },
                    {
                        text: "Machine Pistol - 100 мат."
                    },
                    {
                        text: "Heavy Revolver - 250 мат."
                    },
                    {
                        text: "Вернуться"
                    },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Вооружение') {
                            ...
                            mp.trigger('callRemote', 'mafia.storage.lockPick.take');
                        } else if (e.itemName == 'Влияние') {
                            ...
                            mp.trigger('callRemote', 'mafia.treasury.menu.show');
                        }
                    }
                }
            },
            "mafiaGuns": {
                ...
                items: [{
                    ...
                    {
                        text: "Pistol .50 - 50 мат."
                    },
                    {
                        text: "Mini SMG - 70 мат."
                    },
                    {
                        text: "SMG - 80 мат."
                    },
                    {
                        text: "Sawed-Off Shotgun - 60 мат."
                    },
                    {
                        text: "Double Barrel Shotgun - 70 мат."
                    },
                    {
                        text: "Assault Rifle - 150 мат."
                    },
                    {
                        text: "Carbine Rifle - 200 мат."
                    },
                    {
                        text: "Вернуться"
                    },
            ...
            "vehiclePropAdd": {
                ...
                items: [{
                    ...
                    {
                        text: 'ID салона',
                        values: ["1 (премиум)", "2 (эконом)", "3 (высокий)"],
                    },
                    {
                        text: 'Добавить',
                    },
            ...
            "woodmanItems": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Купить топор') {
                            mp.trigger(`callRemote`, `woodman.items.buy`, e.itemIndex);
                        } 
                        else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        } else if (e.itemName == 'Информация') {
                            selectMenu.show = false;
                            modal.showByName("woodman_help");
                        }
                    } else if (eventName == 'onBackspacePressed') {
                        selectMenu.show = false;
                    }
            ...
            "npcAttakZoneEditor": {
                ...
                header: "NpcAttakZone: редактор зоны",
                items: [
                    { text: "Название", values: ["NpcAttakZone"], i: 0 },
                ...
                refreshLabels() {
                    if (!this.data) return;
                    this.items[0].values = [String(this.data.name || "NpcAttakZone")];
                    this.items[1].values = [String((this.data.points || []).length)];
                    this.items[0].i = 0;
                    this.items[1].i = 0;
                },
                addPointFromPlayer(pos) {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (item.text == 'Добавить точку (моя позиция)') {
                            ...
                            this.clearPoints();
                        } else if (item.text == 'Предпросмотр') {
                            mp.trigger('npcattakzone.zone.preview', JSON.stringify(this.getZonePayload()));
            ...
            "moonshineCraft": {
                name: "moonshineCraft",
                header: "Самогонный аппарат",
                items: [
                    { text: "Навык варщика", values: ["0%"] },
                    { text: "Сахарный тростник", values: ["0 шт."] },
                    { text: "Пустые бутылки", values: ["0 шт."] },
                    { text: "Рецепт", values: ["Недоступно"], i: 0 },
                    { text: "Скрафтить" },
                    { text: "Закрыть" },
                ],
                i: 0,
                ...
                update(data) {
                    ...
                    this.data = data || {};
                    var items = this.items;
                    items[0].values[0] = `${this.data.skillPercent || 0}%`;
                    items[1].values[0] = `${this.data.cane || 0} шт.`;
                    items[2].values[0] = `${this.data.bottles || 0} шт.`;
                    var options = Array.isArray(this.data.options) && this.data.options.length ? this.data.options : ['Недоступно'];
                    items[3].values = options;
                    if (options.length <= 1) items[3].i = 0;
                    else if (items[3].i == null || items[3].i >= options.length) items[3].i = 0;
                },
                getSelectedAmount() {
                    if (!this.data || !Array.isArray(this.data.options) || !this.data.options.length || (this.data.maxBatch || 0) <= 0) return 0;
                    var index = this.items[3].i || 0;
                    index = Math.clamp(index, 0, this.data.options.length - 1);
                    return index + 1;
                },
                handler(eventName) {
                    var item = this.items[this.i];
                    if (eventName == 'onItemSelected') {
                        if (item.text == 'Скрафтить') {
                            var amount = this.getSelectedAmount();
                            if (amount <= 0) {
                                modal.showByName('moonshine_help');
                                return;
                            }
                            mp.trigger('callRemote', 'moonshine.craft.request', amount);
                        } else if (item.text == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    } else if (eventName == 'onBackspacePressed') {
            ...
            "casinoCashier": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        } else if (e.itemName == 'Информация о казино') {
                            selectMenu.show = false;
                            modal.showByName('casino_help');
            ...
            "searchItems": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                            mp.trigger('callRemote', 'police.inventory.search.stop');
                        } else {
                            selectMenu.loader = true;
                            mp.trigger('police.inventory.search.take', e.itemIndex);
                        }
                    }
                    if (eventName == 'onBackspacePressed' || eventName == 'onEscapePressed') {
                        selectMenu.show = false;
            ...
            "factionTreasury": {
                ...
                header: "Управление казной",
                items: [{
                        text: "Состояние счета",
                        values: ['$1000']
                    },
                    {
                        text: "Снятие денег"
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Снятие денег') {
                            selectMenu.showByName("factionTreasuryWithdraw");
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "factionTreasuryWithdraw": {
                name: "factionTreasuryWithdraw",
                header: "Снятие денег",
                items: [{
                        text: "Введите сумму",
                        values: [""],
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Снять деньги') {
                            let amount = parseInt(this.items[0].values[0]);
                            if (isNaN(amount) || amount < 0) return selectMenu.notification = 'Неверная сумма';
                            selectMenu.loader = true;
                            mp.trigger('callRemote', 'factions.treasury.withdraw', amount);
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "governmentTreasury": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Снятие денег') {
                            selectMenu.showByName("factionTreasuryWithdraw");
                        } else if (e.itemName == 'Перевод организации') {
                            selectMenu.showByName("governmentTreasurySend");
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "governmentTreasurySend": {
                name: "governmentTreasurySend",
                ...
                items: [{
                    ...
                    },
                    {
                        ...
                        values: ["LSPD", "LSCSD", "FIB", "EMS",
                            "U.S. Army", "Weazel News", "ЧВК"],
                    },
                    {
                        text: "Перевести",
                    },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Перевести') {
                            ...
                            let data = {
                                amount: amount,
                                targetId: this.items[1].i == 6 ? 15 : this.items[1].i + 2
                            }
                            mp.trigger('callRemote', 'government.treasury.cash.send', JSON.stringify(data));
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Снятие денег') {
                            ...
                            selectMenu.showByName("mafiaTreasurySend");
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "mafiaTreasurySend": {
                ...
                items: [{
                    ...
                    {
                        text: "Выберите организацию",
                        values: ["Italian Embassy", "Mexican Embassy", "Russian Embassy"],
                    },
                    {
                        text: "Перевести",
                    },
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Перевести') {
                            ...
                            let data = {
                                amount: amount,
                                targetId: this.items[1].i + 12
                            }
                            mp.trigger('callRemote', 'mafia.treasury.cash.send', JSON.stringify(data));
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "builder": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Начать работу' || e.itemName == 'Закончить работу') {
                            selectMenu.show = false;
                            mp.trigger('callRemote', 'builder.work.start');
                        } else if (e.itemName == 'Информация') {
                            selectMenu.show = false;
                            modal.showByName("builder_help");
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "narcotismDoctor": {
                name: "narcotismDoctor",
                header: "Лечение наркозависимости",
                items: [],
                i: 0,
                j: 0,
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Пройти сеанс') {
                            mp.trigger('narcotism.treated')
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "drugsCoordinates": {
                name: "drugsCoordinates",
                header: "Координаты грузов",
                items: [],
                i: 0,
                j: 0,
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Купить координаты') {
                            selectMenu.show = false;
                            mp.trigger('drugs.coordinates.buy');
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "drugsSell": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Продать наркотики') {
                            selectMenu.show = false;
                            mp.trigger('drugs.sell');
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
            ...
            "orangePickerSell": {
                name: "orangePickerSell",
                header: "Сбыт апельсинов",
                items: [{
                    text: "Апельсин",
                    values: [`$999`]
                },
                ...
                j: 0,
                init(price) {
                    selectMenu.menus['orangePickerSell'].items[0].values[0] = `$${price}`;
                },
                handler(eventName) {
                    var item = this.items[this.i];
                    var e = {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Продать') {
                            selectMenu.show = false;
                            mp.trigger(`callRemote`, `orangePicker.items.sell`);
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    } else if (eventName == 'onBackspacePressed')
            ...
            "oilRigBuy": {
                ...
                items: [
                    ...
                    {
                        text: "Введите количество баррелей",
                        values: [""],
                        type: "editable"
                    },
                    {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Купить') {
                            let amount = parseInt(this.items[1].values[0]);
                            if (isNaN(amount) || amount < 0) return selectMenu.notification = 'Неверное количество';
                            selectMenu.show = false;
                            mp.trigger('callRemote', 'oilrigs.oil.buy', amount);
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Продать') {
                            ...
                            if (isNaN(amount) || amount < 0) return selectMenu.notification = 'Неверное количество';
                            selectMenu.show = false;
                            mp.trigger('callRemote', 'oilrigs.oil.sell', amount);
                        } else if (e.itemName == 'Закрыть') {
                            selectMenu.show = false;
                        }
                    }
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Закрыть') {
                            ...
                            if (!e.itemName.includes('Вы здесь')) {
                                mp.trigger('callRemote', 'elevators.teleport', e.itemName);
                                selectMenu.show = false;
                            }
                        }
                    }
            ...
            "roomMain": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Список комнат') {
                            mp.trigger('callRemote', 'gungame.room.list');
                        }
                        else if (e.itemName == 'Создать комнату') {
                            mp.trigger('callRemote', 'gungame.room.create.menu');
                        }
                    }
                    if (eventName == 'onEscapePressed') {
                        selectMenu.show = false;
            ...
            "roomCreate": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Создать') {
                            const settings = {
                                location: this.items[0].i,
                                type: this.items[1].i,
                                time: this.items[2].values[0],
                                weapon: this.items[3].i,
                                ammo: this.items[4].values[0],
                                size: this.items[5].values[0]
                            };

                            selectMenu.show = false;
                            mp.trigger(`callRemote`, `gungame.room.add`, JSON.stringify(settings));
                        }
                        else if (e.itemName == 'Назад') {
                            selectMenu.showByName('roomMain');
                        }
                    }
                    if (eventName == 'onEscapePressed') {
                        selectMenu.showByName('roomMain');
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        if (e.itemName == 'Назад') {
                            ...
                            selectMenu.loader = true;
                            mp.trigger('callRemote', 'gungame.room.info', item.id);
                        }
                    }
                    if (eventName == 'onEscapePressed') {
                        selectMenu.showByName('roomMain');
            ...
            "roomInfo": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        ...
                        if (e.itemName == 'Присоединиться') {
                            selectMenu.loader = true;
                            mp.trigger('callRemote', 'gungame.room.enter', parseInt(this.items[0].values[0]));
                        }
                    }
                    if (eventName == 'onEscapePressed') {
                        selectMenu.showByName('roomMain');
            ...
            "roomTeamChoose": {
                ...
                handler(eventName) {
                    ...
                    if (eventName == 'onItemSelected') {
                        if (e.itemName == 'Подтвердить') {
                            selectMenu.show = false;
                            mp.trigger(`callRemote`, `gungame.teams.choose`, this.items[0].i + 1);
                        }
                    }
                    if (eventName == 'onBackspacePressed' || eventName == 'onEscapePressed') {
                        selectMenu.show = false;
    ...
    computed: {
        ...
        leftNumberType() {
            var offset = 0;//3.5; // половина от ширины шарика ползунка
        ...
        headerStyles() {
            return {
                backgroundImage: `url('img/selectMenu/headers/${this.menu.headerImg}')`,
            };
        },
        isEditing() {
...
/*var testMenu = {
    ...
    // header: "Suburban", // заголовок меню, видимый на экране
    headerImg: "ammunation.png",
    items: [{
        ...
        {
            text: "Выбор цвета 2",
            values: ['#f01', '#0f2', '#0bf', '#fb0', '#bf0', '#fb0', '#fb0', '#fb0', '#bf0', '#0fe', '#cd3', 'yellow', 'pink'],
            // i: 0, // индекс выбранного значения пункта меню (необяз.)
        ...
        },
        {
            ...
            // i: 0,
            min: "Мин.", // слово слева от ползунка
            max: "Макс.", // слово справа от ползунка
        },
        {
            text: "Ввод 2",
            values: ["Текст 2"],
